...
def main():
    ...
    with tab3:
        ...
        selected_nifty_option = st.selectbox("Choose a Category", nifty_category_options)
        if st.button("Analyze Stocks"):
            if selected_nifty_indicator_option == "3-SMA Strategy" and selected_nifty_option == "Nifty 50 Analysis":
                nifty_3SMA_display.download_pdf_50_3SMA()
            elif selected_nifty_indicator_option == "3-SMA Strategy" and selected_nifty_option == "Nifty 200 Analysis":
                nifty_3SMA_display.download_pdf_200_3SMA()
            elif selected_nifty_indicator_option == "3-SMA Strategy" and selected_nifty_option == "Nifty 500 Analysis":
                nifty_3SMA_display.download_pdf_500_3SMA()
            elif selected_nifty_indicator_option == "30% down from all time high" and selected_nifty_option == "Nifty 50 Analysis":
                nifty_percent_display.download_pdf_50_percent()
            elif selected_nifty_indicator_option == "30% down from all time high" and selected_nifty_option == "Nifty 200 Analysis":
                nifty_percent_display.download_pdf_200_percent()
            elif selected_nifty_indicator_option == "30% down from all time high" and selected_nifty_option == "Nifty 500 Analysis":
